...
//    if let img = infoconvertFromUIImagePickerControllerInfoKey(UIImagePickerController.InfoKey.originalImage) as? UIImage {
...
//    }
  ...
  @IBAction func submit(_ sender: Any) {
    ...
    call.responseJSON { res in
      ...
      guard let jsonObject = res.value as? [String: Any] else {
